...
const mNum = Math.min(10,20,30,40,50)
console.log(mNum)

// find the maximum value in a set of numbers: -1,-2,-3,-4,-5
const Mnum = Math.max(-1,-2,-3,-4,-5)
console.log(Mnum)
...
const sqRoo = Math.sqrt(144)
console.log(sqRoo)

// find the value of 3 to the power of 7
const pNu = Math.pow(3, 7)
console.log(pNu)
...
const rdVal = Math.floor(9.9)
console.log(rdVal)


// find the absolute value of -1231

const abVal = Math.abs(-1231)
console.log(abVal)
